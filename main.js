...
$(document).ready(
  ...
  function Controller() {
    ...
    var game_board = this.game_board;
  
    this.game_board.create_pieces();
  ...
  function Game_board() {
    ...
    this.off_click = function(x, y, id) {
